...
Authentication (Apple, Google), billing (Apple), and certain analytics, attribution, and advertising functions (for example, the Meta SDK) are provided by third parties and are subject to their own terms and policies. We are not responsible for third-party sites or services, and your use of them is at your own risk.

Data handling by such third parties is described in our Privacy Policy. By using the Service, you acknowledge that these integrations may process information about your use of the Service as described there and in any relevant permission prompts (such as Apple’s App Tracking Transparency prompts).
...
16) Privacy
Your use of the Service is also governed by our Privacy Policy, which explains how we collect, use, and share information, including in connection with third-party services such as analytics and advertising partners (for example, the Meta SDK). By using the Service, you agree to our Privacy Policy.

17) Advertising and Analytics
We may use third-party tools to help us understand how the Service is used, improve features, and, where permitted, optimize ads and measure their performance. These tools may include the Meta SDK and similar technologies.

Where required by law (for example, via Apple’s App Tracking Transparency framework), we will request your permission before allowing tracking for advertising or cross-app purposes. You can change your tracking preferences in your device settings. For more information about our use of advertising and analytics technologies, see our Privacy Policy.
